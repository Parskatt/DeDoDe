...
<p align="center">
    ...
    <br>
    <em>
    We experimentally find that DeDoDe significantly closes the performance gap between detector + descriptor models and fully-fledged matchers.
    </em>
    <br>
        <img src="assets/dedode_roma.png" alt="example" width=80%>
    <br>
    <em>
    The potential of DeDoDe is not limited to local feature matching, in fact we find that we can improve state-of-the-art matchers by incorporating DeDoDe keypoints.
    </em>
</p>
